...
class test_LineWins(PlayTest_UnitTest):
    ...
    def test_Generate_5_of_a_kind_Line_Win_free_game_1c_2c_5c_10c(self):
        line_number = random.randint(1, self.lines_played)
        line_win = LineWin(line_number, 5, 'HOTEL', False, 1, self.bet_multiplier, 'free_games', self.game_denom)
    ...
    def test_getPaytable_free_game_1c_2c_5c_10c(self): 
        ...
        line_win = LineWin(line_number, number_of_symbols, 'HOTEL', False, 1, self.bet_multiplier, 'free_games', self.game_denom)
